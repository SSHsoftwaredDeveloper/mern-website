...
const NavPage = () => {
    ...
    // } else {
    //     fullName = "Unknown"; // or handle this case in a way that makes sense for your application
    // }
    ...
    return (
        <FlexBetween padding="1rem 6%" backgroundColor={alt}>
            ...
            {isNonMobileScreens ? (
                ...
                </FlexBetween>) : (<IconButton onClick={() => setIsMobileMenuToggled(!isMobileMenuToggled)}><Menu /></IconButton>
            )}
            {/*Mobile Nav */}
            {!isNonMobileScreens && isMobileMenuToggled && (
                <Box position="fixed" right="0" bottom="0" height="100%" zIndex="10" maxWidth="500px" minWidth="300px" backgroundColor={background}>
                    ...
                    <Box display="flex" justifyContent="flex-end" p="1rem">
                        <IconButton onClick={() => setIsMobileMenuToggled(!isMobileMenuToggled)}><Close /></IconButton>
                    </Box>
                    {/*Menu Items */}
